...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = function Main(props) {
	  return React.createElement(
	    ...
	    React.createElement(
	      'div',
	      { className: 'container', style: { background: '#f0f0f0', border: '1px solid #b0b0b0', minHeight: 550 } },
	      props.children
	    )
	  );
	};
	  ...
	  return React.createElement(
	    ...
	    React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          IndexLink,
	          { className: 'navbar-brand', to: '/', activeClassName: 'active', activeStyle: { color: 'blue' } },
	          'Weather'
	        )
	      ),
	      React.createElement(
	...
	var Weather = React.createClass({
		...
		render: function render() {
			...
			function renderMessage() {
				...
				if (loader) {
					return React.createElement('img', { src: 'asset/loader-orange.gif', alt: '', className: 'img-responsive ', style: { margin: '0 auto' } });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WeatherForm = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'form',
	      { onSubmit: this.onFormSubmit, className: 'form-horizontal', style: { marginTop: 30 } },
	      React.createElement(
	        'fieldset',
	        null,
	        React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'div',
	            { className: 'col-md-4' },
	            React.createElement('input', { type: 'text', ref: 'location', placeholder: 'your city', className: 'form-control input-md' })
	          )
	        ),
	        React.createElement(
	          'div',
